...
namespace LaBuilderApp
{
	...
	// from: https://xamarinhelp.com/carousel-view-page-indicators/
	// change : image from resource
	...
	public class CarouselIndicators : Grid
	{
		...
		private void Init (int position)
		{
			...
			if (UnselectedImageSource == null)
				UnselectedImageSource = ImageSource.FromResource ("LaBuilderApp.Images." + UnselectedIndicator); //ImageSource.FromFile (UnselectedIndicator);

			if (SelectedImageSource == null)
				SelectedImageSource = ImageSource.FromResource ("LaBuilderApp.Images." + SelectedIndicator); //ImageSource.FromFile (SelectedIndicator);
